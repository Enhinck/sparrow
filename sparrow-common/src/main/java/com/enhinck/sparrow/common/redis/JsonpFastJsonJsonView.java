package com.enhinck.sparrow.common.redis;
...
public class JsonpFastJsonJsonView extends AbstractView {
    ...
    protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
        ...
        String text = JSON.toJSONString(value, SerializeConfig.getGlobalInstance(), valueFilters,
            serializerFeatures);

        if (value instanceof AppResponseEntity) {
            String jsonpFunction = ((AppResponseEntity) value).getJsonpFunction();
