...
public class BaseVO implements Serializable{
	...
	private static final long serialVersionUID = 8018920491527367842L;

	@ApiModelProperty(value = "唯一主键ID")
	private Long id;

    @ApiModelProperty(value = "创建时间",example = "2018-09-01 17:00:00")
    @JSONField (format="yyyy-MM-dd HH:mm:ss")
    private Date              gmtCreate;
    
    @ApiModelProperty(value = "修改时间",example = "2018-09-01 17:00:00")
    @JSONField (format="yyyy-MM-dd HH:mm:ss")
